(function (global, factory) {
    ...
    class Logger {
        ...
        constructor(options = {}) {
            var _a, _b, _c;
            this.level = (_a = options.level) !== null && _a !== void 0 ? _a : exports.LogLevel.INFO;
        ...
        getConfiguration() {
            return {
                level: this.level,
                levelName: exports.LogLevel[this.level],
    ...
    class NavigationObserver {
        constructor(options) {
            ...
            this.hasCollectedMetrics = false;
            // 性能观察器和超时控制
            this.perfObserver = null;
            this.timeoutId = null;
            // 配置常量
            this.MAX_WAIT_TIME_MS = 10000; // 10秒超时限制
            this.MAX_POLL_ATTEMPTS = 10; // 最大轮询次数
            this.POLL_INTERVAL_MS = 200; // 轮询间隔
         ...
         * 通过轮询方式检查并获取导航性能数据
         */
        pollForNavigationData(attemptCount = 0) {
            // 超过最大尝试次数，强制收集
            ...
            if (this.isLoadEventComplete(navEntry)) {
                ...
                // 延迟后再次尝试
                setTimeout(() => this.pollForNavigationData(attemptCount + 1), this.POLL_INTERVAL_MS);
            }
        }
        /**
         * 获取最新的导航性能条目
         */
        getLatestNavigationEntry() {
         ...
         * 收集导航计时数据
         */
        collectNavigationData(forceProcess = false) {
            const navEntry = this.getLatestNavigationEntry();
            if (!navEntry) {
    ...
    class PerfObserverKit {
        ...
        determineLogLevel(options) {
            if (options.logLevel !== undefined) {
                ...
                if (level >= exports.LogLevel.NONE && level <= exports.LogLevel.DEBUG) {
                    return level;
                }
            }
            // 基于debug选项设置默认日志级别
            return options.debug ? exports.LogLevel.DEBUG : exports.LogLevel.WARN;
        }
        /**
         * 规范化模块配置为标准格式
        ...
        setDebugMode(enabled) {
            ...
            if (enabled && this.options.logLevel < exports.LogLevel.DEBUG) {
                this.setLogLevel(exports.LogLevel.DEBUG);
            }
            // 确保生产环境也可以看到日志
            logger.setOptions({
            ...
            try {
                ...
                this.coreWebVitalsObserver = new CoreWebVitalsObserver({
                    onUpdate: (coreWebVitalsMetrics) => {
                        ...
                        this.notifyMetricsUpdate(exports.MetricType.WEB_VITALS, coreWebVitalsMetrics);
                    },
        ...
        startResourceTimingMonitoring() {
            try {
                ...
                this.resourceTimingObserver = new ResourceTimingObserver((resources) => {
                    this.notifyMetricsUpdate(exports.MetricType.RESOURCES, resources);
        ...
        startLongTasksMonitoring() {
            try {
                ...
                this.longTasksObserver = new LongTasksObserver({
                    onUpdate: (longTasks) => {
                        this.notifyMetricsUpdate(exports.MetricType.LONG_TASKS, longTasks);
            ...
            try {
                ...
                this.navigationObserver = new NavigationObserver({
                    onUpdate: (navigationMetrics) => {
                        ...
                        this.notifyMetricsUpdate(exports.MetricType.NAVIGATION, navigationMetrics);
                    },
                    enabled: options.enabled,
            ...
            try {
                ...
                this.browserInfoObserver = new BrowserInfoObserver({
                    onUpdate: (browserInfo) => {
                        ...
                        this.notifyMetricsUpdate(exports.MetricType.BROWSER_INFO, browserInfo);
                    },
    ...
    exports.CoreWebVitalsObserver = CoreWebVitalsObserver;
    exports.PerfObserverKit = PerfObserverKit;
    exports["default"] = LibraryExports;
    exports.logger = logger;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=perf-observer-kit.browser.js.map
